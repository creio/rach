...
# https://raw.githubusercontent.com/creio/rach/main/rach.sh
...
xorg-xkill xorg-xrdb xorg-xinput
...
konsole dolphin ark kate ffmpegthumbs kwalletmanager kdeconnect gwenview
baloo kcalc partitionmanager power-profiles-daemon gwe
capitaine-cursors ttf-jetbrains-mono-nerd
...
useradd -m -g users -G "audio,video,input,adm,network,storage,power,wheel" -s /bin/bash "$NEW_USER"
